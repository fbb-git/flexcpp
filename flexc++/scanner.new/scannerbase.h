...
protected:
    ...
    static size_t  const s_nRules = 70;
...
protected:
    ...
    ScannerBase(std::string const &filename);
...
inline void ScannerBase::Input::destroy()
{
    delete d_in;
}
...
inline void ScannerBase::switchStreams(std::istream &iStream)
{
