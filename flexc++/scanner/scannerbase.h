...
protected:
    ...
    int     const (*d_dfaBase__)[76];

    static int     const s_dfa__[][76];
    static int     const (*s_dfaBase__[])[76];
...
protected:
    ScannerBase(std::istream &in, std::ostream &out, std::istream *ip);
...
//  n characters, rescanning the rest. 
    ...
    void            print__(int token);         // optionally print token
